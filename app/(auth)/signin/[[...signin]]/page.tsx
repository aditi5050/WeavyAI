    ...
    <div id="weavy-main" style={{ 
      ...
      <main style={{ display: 'flex', flexDirection: 'column', flex: 1, width: '100%' }}>
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
          {/* Logo header */}
          <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', padding: '0', backgroundColor: 'transparent' }}>
